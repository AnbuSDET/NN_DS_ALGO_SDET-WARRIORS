...
Scenario: Testing the TryHere button in the Binary Tree Traversals Page
  ...
  Scenario: Testing the Implementation of Binary Trees link in the treepage
    ...
    Scenario: Testing the TryHere button in the Implementation of Binary Trees Page
...
Scenario: Testing the online editor in the Implementation of Binary Trees page with valid python code
	 		Given User moves to the Implementation of Binary Trees page and clicks the Try here button in this Page
		  When The user write the Valid python code in Editor and Clicks Run button
  		Then The User should be able to see the output in the console

	Scenario: Testing the online editor in the Implementation of Binary Trees page with invalid python code
	 		Given User moves to the Implementation of Binary Trees page and clicks the Try here button in this Page
			When  The user write the InValid python code in Editor and Clicks Run button
			Then  The User should be able to see error message in the pop message

	Scenario: Testing the online editor in the Implementation of Binary Trees page with no code at all
			Given User moves to the Implementation of Binary Trees page and clicks the Try here button in this Page
		  When The user clicks the Run without any Codes
	    Then The User should should be in the same page with No error message
  ...
  Scenario: Testing the Applications of Binary trees link in the treepage
    ...
    Then user will navigate to Applications of Binary trees page
      ...
      Scenario: Testing the TryHere button in the Applications of Binary Trees Page
  	  When User moves to the Applications of Binary Trees page and clicks the Try here button in this Page
		  Then The User should be redirected to Python Editor page
    

Scenario: Testing the online editor in the Applications of Binary Trees page with valid python code
	 		Given User moves to the Applications of Binary Trees page and clicks the Try here button in this Page
		  When The user write the Valid python code in Editor and Clicks Run button
  		Then The User should be able to see the output in the console

	Scenario: Testing the online editor in the Applications of Binary Trees page with invalid python code
	 		Given User moves to the Applications of Binary Trees page and clicks the Try here button in this Page
			When  The user write the InValid python code in Editor and Clicks Run button
			Then  The User should be able to see error message in the pop message

	Scenario: Testing the online editor in the Applications of Binary Trees page with no code at all
			Given User moves to the Applications of Binary Trees page and clicks the Try here button in this Page
		  When The user clicks the Run without any Codes
	    Then The User should should be in the same page with No error message
  ...
  Scenario: Testing the Binary Search Trees link in the treepage
    ...
    Then user will navigate to Binary Search Trees page
      ...
      Scenario: Testing the TryHere button in the Binary Search Trees Page
  	  When User moves to the Binary Search Trees page and clicks the Try here button in this Page
		  Then The User should be redirected to Python Editor page
    

Scenario: Testing the online editor in the Binary Search Trees page with valid python code
	 		Given User moves to the Binary Search Trees page and clicks the Try here button in this Page
		  When The user write the Valid python code in Editor and Clicks Run button
  		Then The User should be able to see the output in the console

	Scenario: Testing the online editor in the Binary Search Trees page with invalid python code
	 		Given User moves to the Binary Search Trees page and clicks the Try here button in this Page
			When  The user write the InValid python code in Editor and Clicks Run button
			Then  The User should be able to see error message in the pop message

	Scenario: Testing the online editor in the Binary Search Trees page with no code at all
			Given User moves to the Binary Search Trees page and clicks the Try here button in this Page
		  When The user clicks the Run without any Codes
	    Then The User should should be in the same page with No error message
  ...
  Scenario: Testing the Implementation Of BST link in the treepage
    ...
    Then user will navigate to Implementation Of BST page
      ...
      Scenario: Testing the TryHere button in the Implementation Of BST link Page
  	  When User moves to the Implementation Of BST page and clicks the Try here button in this Page
		  Then The User should be redirected to Python Editor page
    

Scenario: Testing the online editor in the Implementation Of BST page with valid python code
	 		Given User moves to the Implementation Of BST page and clicks the Try here button in this Page
	 		 When The user write the Valid python code in Editor and Clicks Run button
  		Then The User should be able to see the output in the console

	Scenario: Testing the online editor in the Implementation Of BST link page with invalid python code
	 		Given User moves to the Implementation Of BST page and clicks the Try here button in this Page
			When  The user write the InValid python code in Editor and Clicks Run button
			Then  The User should be able to see error message in the pop message

	Scenario: Testing the online editor in the Implementation Of BST link page with no code at all
			Given User moves to the Implementation Of BST page and clicks the Try here button in this Page
		  When The user clicks the Run without any Codes
	    Then The User should should be in the same page with No error message
